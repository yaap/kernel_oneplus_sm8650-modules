...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE, 24, 24),
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE_30, 27, 27),
...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_CK_NOT_SUPPORTED, 38, 38),
