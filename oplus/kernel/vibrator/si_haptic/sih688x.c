...
static void sih688x_get_ram_data2(sih_haptic_t *sih_haptic, uint8_t *buf, uint32_t size)
{
...
static void sih688x_set_ram_addr2(sih_haptic_t *sih_haptic, uint32_t base_addr)
{
	uint8_t ram_addr[2] = {0, 0};
...
haptic_func_t sih_688x_func_list = {
	...
	.si_get_ram_data = sih688x_get_ram_data2,
	.set_ram_data = sih688x_set_ram_data,
	.set_ram_addr = sih688x_set_ram_addr,
	.si_set_ram_addr = sih688x_set_ram_addr2,
