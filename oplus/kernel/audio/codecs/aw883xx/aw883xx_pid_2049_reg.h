/*
* aw883xx_pid_2049_reg.h aw883xx codec driver
*
...
#define AW_PID_2049_FIRMWARE_VERSION	(0x0002)
...
#define AW_PID_2049_DSP_ROM_CHECK_ADDR		(0x12C8)
#define AW_PID_2049_DSP_ROM_CHECK_DATA		(0xF7FE)
...
/* bit 0 */
#define AW_PID_2049_DSP_MONITOR_VOLT_EN_MASK		(~(1 << 0))
...
#define AW_PID_2049_DSP_MONITOR_TEMP_EN_MASK		(~(1 << 4))
#define AW_PID_2049_DSP_EXTN_TEMP_EN_MASK		(~(1 << 14))
...
#define AW_PID_2049_DSP_CFG_ADPZ_RA_SHIFT		(12)
...
#define AW_PID_2049_DSP_REG_TEMP_SWITCH_ADDR		(0x9D71)/*16bit*/
...
#define AW_PID_2049_DSP_ST_S1				(0x805C)
#define AW_PID_2049_DSP_ST_E1				(0x8498)
#define AW_PID_2049_DSP_ST_S2				(0x9C00)
#define AW_PID_2049_DSP_ST_E2				(0x9C5D)
#define AW_PID_2049_CRC_VALUE_CHECK_REG		(0x83E8)/*16bit*/
#define AW_PID_2049_FIRMWARE_VERSION_REG	(0x8CD0)/*16bit*/
