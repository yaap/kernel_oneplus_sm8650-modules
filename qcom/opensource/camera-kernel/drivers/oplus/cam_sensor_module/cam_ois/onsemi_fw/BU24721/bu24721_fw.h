...
typedef		unsigned  int				OIS_UWORD;
...
int			bu24_write_flash_fw_data(struct cam_ois_ctrl_t *o_ctrl);
...
void		Gyro_data(struct cam_ois_ctrl_t *o_ctrl,OIS_UBYTE count, OIS_UBYTE gyro_type);
